...
const ICONS = [TrendingUp, MonitorPlay, Video, Scissors];
      ...
      <div className="container mx-auto px-4 md:px-6 relative z-10">
        <div className="max-w-6xl mx-auto">
          <div className="text-center mb-16 md:mb-24">
            <span className="pill-tag mb-6">{services.pill_text}</span>
            <h2 className="text-4xl md:text-6xl font-black mb-6 text-brand-primary leading-[1.1] tracking-tight">
              {services.headline1} <br /><span className="text-brand-accent">{services.headline2}</span>
            </h2>
            ...
            {services.items.map((service, index) => {
              ...
              return (
                ...
                >
                  ...
                  <p className="text-brand-secondary text-base leading-relaxed font-medium">{service.description}</p>
                </motion.div>
              );
            })}
          </div>
